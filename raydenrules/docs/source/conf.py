...
# raydenrules documentation build
...
from raydenrules import __version__ as release
...
htmlhelp_basename = "raydenrulesdoc"
...
def autodoc_process_docstring(app, what, name, obj, options, lines):  # noqa: PLR0913
    """Process docstrings to remove arrows in examples."""
    remove_arrows_in_examples(lines)


def skip(app, what, name, obj, skip, options):  # noqa: PLR0913
    """Determine which members to skip during documentation generation."""
    # Using standard Sphinx function signature (can't change parameter count)
    # noqa: PLR0913
    if name == "__init__":
        return False
    return skip
